...
--
-- Host: localhost    Database: tic_tac
-- ------------------------------------------------------
...
CREATE TABLE `friends` (
  ...
  PRIMARY KEY (`playerName`,`friendName`),
  KEY `friendName` (`friendName`),
  CONSTRAINT `friends_ibfk_1` FOREIGN KEY (`playerName`) REFERENCES `players` (`userName`),
  CONSTRAINT `friends_ibfk_2` FOREIGN KEY (`friendName`) REFERENCES `players` (`userName`)
...
INSERT INTO `friends` VALUES ('ahmed','ahmedsalah'),('ahmedsalah','mohamedfarid'),('ahmedsalah','omarhussien'),('mohamedfarid','omarhussien'),('youssefhamada','omarhussien'),('ahmed','testPlayer'),('ahmedsalah','yosrahesham'),('mohamedfarid','yosrahesham'),('youssefabdelnaser','yosrahesham'),('ahmedsalah','youssefabdelnaser'),('omarhussien','youssefabdelnaser'),('ahmedsalah','youssefhamada'),('mohamedfarid','youssefhamada');
...
--
-- Table structure for table `gamesMoves`
--

DROP TABLE IF EXISTS `gamesMoves`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gamesMoves` (
  `moveNumber` tinyint NOT NULL,
...
--
-- Dumping data for table `gamesMoves`
--

LOCK TABLES `gamesMoves` WRITE;
/*!40000 ALTER TABLE `gamesMoves` DISABLE KEYS */;
/*!40000 ALTER TABLE `gamesMoves` ENABLE KEYS */;
UNLOCK TABLES;
